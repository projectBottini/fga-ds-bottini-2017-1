var productSeeds = [
  {
    "sku" : "illudium-q36",
    "name" : "Chatbot para Facebook Básico",
    ...
    "vendor" : {
      ...
      "name" : "Bots para Conversação"
    }
  },
  {
    "sku" : "honeymoon-mars",
    "name" : "Chatbot para Agendamento de Reuniões",
    ...
    "vendor" : {
      "id" : 2,
      "slug" : "red-planet",
      "name" : "Bots para Agendamento"
    }
  },
  {
    "sku" : "johnny-liftoff",
    "name" : "Chatbot para Telegram Básico",
  ...
  {
    "sku" : "mars-mobile",
    "name" : "Chatbot para Telegram Avançado",
  ...
  {
    "sku" : "mars-trek",
    "name" : "Chatbot para gerenciamento de equipes",
    "image" : "mars-trek.jpg",
    ...
    "vendor" : {
      "id" : 3,
      "slug" : "marinaris",
      "name" : "Bots para Vendas"
    }
  },
  {
    "sku" : "martian-sunset-cruise",
    "name" : "Chatbot para venda de produtos de beleza",
  ...
  {
    "sku" : "moon-races",
    "name" : "Chatbot para negociação de preços",
  ...
  {
    "sku" : "one-way-reentry",
    "name" : "Chatbot para Slack Básico",
  ...
  },
  {
    ...
    "name" : "Chatbot avançado para gerenciamento de horários",
  ...
  {
    "sku" : "your-own-crater",
    "name" : "Chatbot básico para agendamento de consultas",
...
if (Vendors.find().count() === 0){
    var vendors = [
    {
      ...
      slug: "martian-armaments",
      name : "Bots para Conversação",
      description: "Aqui você encontra os melhores bots para dialogar com seus clientes e usuários de forma intuitiva."
    },
    {
      id : 2,
      slug: "red-planet",
      name : "Bots para Agendamento",
      description: "Não tenha dor de cabeça na hora de gerenciar seus agendamentos, avise seus clientes, não perca um horário mais! "
    },
    {
      id : 3,
      slug: "marinaris",
      name : "Bots para Vendas",
      description : "Não perca mais uma venda! Com os bots para vendas, sua venda é garantida!"
    }
  ];
